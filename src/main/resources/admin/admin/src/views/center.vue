  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item v-if="flag=='yonghu'"  label="会员" prop="huiyuan">
          <el-select v-model="ruleForm.huiyuan" :disabled="true" placeholder="请选择会员">
            <el-option
                v-for="(item,index) in yonghuhuiyuanOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
      ...
      <el-col :span="12">
        <el-form-item  v-if="flag=='yonghu'" label="有效期" prop="youxiaoqi">
            <el-date-picker
...
export default {
  ...
  mounted() {
    ...
    this.yonghuhuiyuanOptions = "否,是".split(',')
  },
  methods: {
