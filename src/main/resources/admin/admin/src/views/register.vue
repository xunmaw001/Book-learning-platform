      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<el-form-item label="作者账号" class="input" v-if="tableName=='zuozhe'">
			  <el-input v-model="ruleForm.zuozhezhanghao" autocomplete="off" placeholder="作者账号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='zuozhe'" class="input-group">
			...
			<el-form-item label="作者姓名" class="input" v-if="tableName=='zuozhe'">
			  <el-input v-model="ruleForm.zuozhexingming" autocomplete="off" placeholder="作者姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='zuozhe'" class="input-group">
